...
class ResourceFiles(object):
    ...
    def __init__(self, org_name, username, password, environment):
        ...
        self.url = 'https://api.enterprise.apigee.com/v1/organizations/%s/%s/resourcefiles' % (org_name, environment)
